...
app.post("/action2", (req, res) => {
  ...
  db.query(sql, (err, result) => {
    ...
    var mailoptions = {
      from: from,
      to: nam,
      subject: "Sucessfully created account in IIITA Bus Service",
...
app.post("/action4", (req, res) => {
  ...
  let sql = `INSERT INTO bus_info (departure_time,drop_point,pick_up,date_book,Email_Id) VALUES (STR_TO_DATE('${time}', '%h:%i %p'),'${drop}','${From}','${date}','${namq}') `;
  asql = sql;
...
app.post("/action6", async (req, res) => {
  ...
  // // console.log(ticket_num);
        ...
        // })
  // console.log(q,e);
  let sql = `INSERT INTO Ticket( drop_point, date_book, transaction_id, departure_time) VALUES ('${drop}','${date}','${transaction_id}',STR_TO_DATE('${time}', '%h:%i %p')); `;
                  ...
                  <div class="col-lg-6">
                    <div class="card-body p-md-5 mx-md-4">
                      ...
                      <div class="text-center">
                        ...
                        <h4 class="mt-1 mb-5 pb-1">We are IIITA Travelling team</h4>
                      </div>
